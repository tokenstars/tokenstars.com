...
return [
    "main" => [
        ...
        "onepager" => "One-pager",
        "onepager_file" => "team_onepager_en",
        "reasons" => "5 reasons to get TEAM",
        "reason_title" => "5 reasons to join TEAM",
        "reason_1" => "<b>Huge audience around celebrities:</b> 20 top stars support TokenStars and participate in our project.
                       They bring expertise and attract a huge fan audience to our platform.",
        "reason_2" => "<b>TEAM will be constantly demanded</b> by fans and advertisers because tokens are required to get access and pay for
                       interaction on the platform. TokenStars encourages interaction between stars, advertisers and millions
                       of fans, and provides strong incentives to token holders for participation.",
        "reason_3" => "<b>Large market:</b> TEAM disrupts a $100 billion industry that’s grown ~4 times over the last 15 years.",
        "reason_4" => "<b>Platform is live:</b> The first module was launched in 2017. The TokenStars platform is built on blockchain
                       to provide transparency and scalability to the highly lucrative celebrity management industry.",
        "reason_5" => "<b>Successful track record:</b> Having successfully started with the ACE token for tennis ($4.9M+ raised by the end of the sale),
                       TokenStars combines sports & showbiz in the TEAM token, supported by world-known celebrities
                        (FIFA World Cup champs and NHL stars on the advisory board)."
    ],
    "other" => [
        "whitepaper" => "/upload/files/team_whitepaper.pdf"
    ],
    "main_form" => [
        "title" => "Token pre-sale start",
        "subtitle1" => "TEAM Token Sale will start in December and close by the end of&nbsp;January&nbsp;2018",
        "details_soon" => "Details to be updated soon",
        "bonus1" => ":bonus Bonus",
        "bonus1_text" => "for the first 5 days of pre sale",
        "date" => "7 November, 2017, 12:00 pm PDT",
        "subscribe" => "Subscribe",
        "crowdsale" => "Apply for Crowdsale",
        "started" => "Token Sale started",
        "closes" => "Token Sale closes soon",
        "over" => "Token Sale is over",
        "kyc" => "Complete KYC",
        "how_to" => "How to add TEAM tokens",
        "bonus_date" => "till 28 March, 12:00pm PDT",
        "contribute" => "Contribute",
        "payment" => "Pay with BTC, ETH, LTC, BCH, NEO",
        "free_token" => "Get free TEAM token"
    ],
    "token" => [
        "title" => "Token",
    ...
    "allocation" => [
        "title_parameters" => "Token Sale Parameters",
        "image" => "token-parameters-en",
        "token_image" => "tokens-en",
        "token_allocations" => [
            "line1" => [
                "color" => "#2A60FF",
                "value" => "60",
                "label" => "<b>Contributors</b> <br />45,000,000"
            ],
            "line2" => [
                "color" => "#17E9B6",
                "value" => "20",
                "label" => "<b>Advisors & Team</b> <br />15,000,000"
            ],
            "line3" => [
                "color" => "#5A3DA4",
                "value" => "20",
                "label" => "<b>Network growth & Community</b> <br />15,000,000"
            ],
            "line4" => [
                "color" => "transparent",
                "value" => "",
                "label" => "<b>Max supply</b> <br />75,000,000 TEAMs"
            ]
        ]
    ],
    "roadmap" => [
        "stars_graph_image" => "star-graph",
        "revenue_graph_image" => "revenue-graph-en"
    ],
    "ambassadors" => [
        "title" => "Ambassadors",
        "details" => "Click ambassador photo to learn more",
        ...
        "mattheus" => [
            ...
            "title" => "Football",
            "info" => "FIFA World Cup champion (1990). UEFA European champion (1980). 7-time winner of German Bundesliga and 3-time winner of German Cup. Champion of Italian Serie A championship. 2-time winner of UEFA Cup (1991, 1996). Awarded the Golden Ball (1990) and FIFA World Player of the Year (1991). Played for Bayern, Borussia (M), Inter Milan and German national team.",
            "flag" => ['gr']
        ],
        "haas" => [
            "name" => "Tommy Haas",
            "title" => "Tennis",
            "info" => "No. 2 in ATP rating. Silver Olympics medalist (Sydney, 2000). Winner of 15 ATP titles, incl. ATP Masters in Stuttgart. Triple Australian Open semi-finalist and Wimbledon semi-finalist. Tournament Director at Indian Wells Masters.",
            "flag" => ['gr']
        ],
        "kucherov" => [
            "name" => "Nikita Kucherov",
            "title" => "Hockey",
            "info" => "Plays for the Tampa Bay Lightning (NHL) and Russian national team. No. 1 goal scorer of current NHL season (2017/18). Bronze medalist of the World Championship (2017). Silver medalist of the Junior World Championship (2012). Included in the NHL All-Star team (2017). NHL Stats: 125 goals and 268 points.",
            "flag" => ['ru']
        ],
        "zambrotta" => [
            "name" => "Gianluca Zambrotta",
            "title" => "Football",
            "info" => "FIFA World Cup champion (2006). UEFA European championship silver medalist (2000). 3-time Italian Serie A champion (’02, ’03, ’11). 4-time winner of Italian and Spanish Cups. 2006 FIFA World Cup All-Star Team. Played for Juventus, Barcelona, Milan and Italian national team. Coaches Jiangsu Suning (China) with Fabio Capello.",
            "flag" => ['it']
        ],
        "redfoo" => [
            "name" => "Redfoo",
            "title" => "Music Star",
            "info" => "American pop star, DJ, singer and songwriter best known as part of the LMFAO. Author of the famous hits “I’m sexy and I know it” and “Party Rock Anthem”. Won more than 43 music awards, including 11 Billboard music awards, 4 World Music Awards, 5 MTV Music awards and 2 Grammy Nominations.",
            "flag" => ['us']
        ],
        "lingham" => [
            "name" => "Vinny Lingham",
...
AUCTION COMPLET",
        ...
        "demekhine" => [
            ...
            "title" => "Coaching",
            "info" => "Tennis coach with 8 years of experience, retired ATP tennis player, Vera Zvonareva's head coach in 2010-2011 (No.2 in WTA rankings, rising from No.22 at the beginning of coaching) - Wimbledon & US Open 2010 singles finalist, Australian Open 2011 semi-finalist. A-level GPTCA certification holder (Global Professional Tennis Coach Association).",
            "flag" => ['ru']
        ],
    ...
    "crowdsale" => [
        "title" => "Apply for the crowdsale now <br class='desktop-only'>and get a&nbsp;Bonus!",
        "subtitle" => "Whitelisting guarantees the exclusive EXTRA BONUS in addition to all other bonuses that can be used only on DAY 1. <br />Please fill in the form to participate in the TokenStars Token Sale!",
        "line1" => "guaranteed (and earliest) access to purchase;",
        "line2" => "opportunity to buy Team tokens with special terms;",
        "line3" => "access to referral program to share with the community and earn additional tokens.",
        "text1" => "Please fill in the form to participate in TokenStars' Token&nbsp;Sale!",
        "range" => "Amount range",
        "btn" => "Submit",
        "response_title" => "Thank you!",
        "response_text" => "Please check your email carefully to receive details and updates on the crowdsale."
    ],
    "events" => [
        "title" => "Events",
        "america" => "America",
    ...
    "features" => [
        "feature1" => "12 modules to connect stars, fans and advertisers",
        "feature2" => "$100 Billion industry, 4 Billion sports <br class='desktop-only' />fans",
        "feature3" => "11 sports stars (World and Olympic champs) as advisors",
        "feature4" => "Internal + Ethereum blockchain to be implemented",
        "feature5" => "Proven by ACE Token sale success (20k+ people in&nbsp;community)",
        "btn" => "Read More"
    ],
    "rico" => [
    ...
    "modules" => [
        "scroll" => "Scroll to the section's end",
        "module_1" => [
