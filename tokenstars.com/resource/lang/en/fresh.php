...
return [
    ...
    "platform_modules" => [
        ...
        "modules_description" => "Modules",
        "hide_modules" => "Hide Modules",
    ],
    ...
    "bounty_fan_club" => [
        "title" => "Bounty Fan Club",
        "live" => "Live",

        "platform_1" => [
            "title" => "Bounty Fan Club",
            "button" => "Help your favorite stars&nbsp;&nbsp;►",
            "text" => "Help your favorite stars by completing different tasks and earn ACE and TEAM tokens."
        ],
    ...
    "fan_communication" => [
        ...
        "platform_1" => [
            "title" => "Fan communication",
            "button" => "Get closer to the Stars&nbsp;&nbsp;►",
            "text" => "Get closer to the Stars using your ACE and TEAM tokens to communicate with them and get a unique experience with your favorites involved"
        ],
    ...
    "project_news" => [
        ...
        'items' => [
            [
                "title" => "Kudermetova trains with her fan",
                "text" => "TokenStars conducted first personal training between V. Kudermetova (WTA 60) and her personal fan via Fan Communications module.",
                "img" => "may-2019-kudermetova-fan-train_600x350.jpg",
                "medium_url" => "https://www.youtube.com/watch?v=bSeUYO46CYI&feature=youtu.be",
                "post_date" => "18 june, 2019",
                "timestamp" => 1560816000,
            ],

            [
                "title" => "May's Highlights in TokenStars",
                "text" => "In May we were focused on growing the adoption of ACE and TEAM tokens and on creating new forms of communication between players, fans and token holders.",
                "img" => "may-2019-report_600x350.jpg",
                "medium_url" => "https://medium.com/@TokenStars/tokenstars-monthly-report-what-may-flowers-were-brought-by-april-showers-4285ecb93034",
                "post_date" => "07 june, 2019",
                "timestamp" => 1559865600,
            ],

            [
                "title" => "5 News from TokenStars in April Report",
                "text" => "2Q we started with new ambitious goals and strive to achieve them. We continued to expand our clients’ portfolio, cooperated more closely with our community and signed a promising partnership agreement.",
                "img" => "april-2019-monthly-report_600x350.jpg",
                "medium_url" => "https://medium.com/@TokenStars/tokenstars-april-report-this-five-news-will-give-you-ten-5b3c0fec588f",
                "post_date" => "08 may, 2019",
...
Here are the results and our further plans.",
    ...
    'partners' => [
        ...
        'items' => [
            [
                "title" => "Tokenator",
                "img" => "p_tokenator.png",
                "url" => "https://tokenator.io"
            ],
            [
                "title" => "Decentralized systems",
                "img" => "p_decentralized-systems.png",
                "url" => "/"
            ],
            [
                "title" => "Ico Box",
            ...
            [
                "title" => "Nektorov, Saveliev & partners",
                "img" => "p_nektorov-saveliev.png",
                "url" => "http://www.nsplaw.com"
            ],
            [
                "title" => "AIDCOIN",
                "img" => "p_aidcoin.png",
    ...
    "items" => [
        ...
        "item5" => "Voting",
        "item6" => "Predictions",
        "item7" => "Bounty Fan <br /> Club",
        "item8" => "Fan Communications",
        "item9" => "Auctions",
        "item10" => "Advertising and <br /> Smart-ontracts",
        "item11" => "Brands Relations",
