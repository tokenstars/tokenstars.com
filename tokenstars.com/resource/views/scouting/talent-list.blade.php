		...
		<div class="card talent-item hoverable w-100 mx-auto ">
			<div>
				<div class="talent-item-img-wrapper d-inline-block position-relative">
					...
					<img class="talent-item-img" src="@if($player->photo == 'https://via.placeholder.com/402x450'){{'../images/talent-thumb-unkown.jpg'}}@else{{$player->photo}}@endif" alt="" width="285" height="250">
			...
			<div class="badge badge-token badge-lg badge-token-ace text-uppercase talent-item-token position-absolute text-nowrap">ace</div>
