        ...
        <tr>
            <td align="center" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" width="500" class="content-holder">
                    ...
                    <tr>
                        ...
                        <td class="header">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="320">
                                        <br><a href="https://tokenator.io?utm_campaign=password&utm_medium=email&utm_source=tr_email"><img src="https://gallery.mailchimp.com/9102e6e0eb8b8634bad275065/images/3aadb6ad-e86a-47ef-a218-416015f4b699.png" alt="Tokenator" height="40"></a>
                                    </td>
                                    <td align="right"></td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td colspan="3">
                            <br><img src="https://gallery.mailchimp.com/9102e6e0eb8b8634bad275065/images/3ad32b13-fcb7-4ffa-bed4-0dcdf58048d4.jpg" alt="" width="100%">
                        </td>
                    </tr>
                    <!-- Message -->
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        ...
                                        <p class="medium-font">Thank you for participating in the success of the token sale {{$promo->currency->name}}!</p>
                                        <p class="medium-font">Insert an ERC20 wallet address in the profile section of your personal account to receive {{$promo->currency->code}} tokens.</p>
                                <tr align="center">
                                    <td>
                                        <a href="{{route('profile')}}" class="big-btn">Go to personal account</a>
                                    </td>
                                </tr>
                                </td>
                                </tr>
