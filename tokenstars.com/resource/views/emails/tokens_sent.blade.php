        ...
        <tr>
            <td align="center" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" width="500" class="content-holder">
                    ...
                    <tr>
                        ...
                        <td class="header">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="320">
                                        <br><a href="https://tokenator.io?utm_campaign=erc20sent&utm_medium=email&utm_source=tr_email"><img src="https://gallery.mailchimp.com/9102e6e0eb8b8634bad275065/images/3aadb6ad-e86a-47ef-a218-416015f4b699.png" alt="Tokenator" height="40"></a>
                                    </td>
                                    <td align="right"></td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td colspan="3">
                            <br><a href="{{route('portfolio')}}?utm_campaign=erc20sent&utm_medium=email&utm_source=tr_email"><img src="https://gallery.mailchimp.com/9102e6e0eb8b8634bad275065/images/3ad32b13-fcb7-4ffa-bed4-0dcdf58048d4.jpg" alt="" width="100%"></a>
                        </td>
                    </tr>
                    <!-- Message -->
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td>
                                        ...
                                        <p class="medium-font">Your tokens were successfully sent to the ERC-20 wallet you provided.</p>
                                        <p class="medium-font">Thanks for joining the {{$promo->currency->name}} token sale!</p>
                                <tr align="center">
                                    <td>
                                        <a href="{{route('portfolio')}}" class="big-btn">Go to the personal account</a>
                                    </td>
                                </tr>
                                </td>
                                </tr>
