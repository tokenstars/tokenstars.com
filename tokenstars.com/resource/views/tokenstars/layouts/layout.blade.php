...
<header class="header">
    <div class="wrap">
        <div class="header-logo">
            ...
            <img class="header-logo__image j-jump-to-top" alt="" src="/images/ace/logotype_ace.png" />
        </div>
                ...
                <!--<li class="header-nav__listitem">
                    <div class="header-nav__lang">
                        ...
                        <select class="header-nav__lang_selector j-lang-selector">
                            ...
                            <option {{ $lang == 'en' ? 'selected' : '' }} value="/en/ace">Русский</option>
                            <option {{ $lang == 'en' ? 'selected' : '' }} value="/en/ace">한국어</option>
                            <option {{ $lang == 'en' ? 'selected' : '' }} value="/en/ace">中文（简体）</option>
                            <option {{ $lang == 'en' ? 'selected' : '' }} value="/en/ace">日本語</option>
                        </select>
                    </div>
                </li>-->
    ...
    <div class="wrap">
        <div class="row">
            <div class="huge-margin-before">
                ...
                <a href="https://github.com/tokenstars/ace-token" target="_blank" class="footer-social-link" onclick="ga('send', 'event', 'click', 'github', 'footer');"><img title="GitHub" alt="GitHub" src="/images/ace/github.png" /></a>
            </div>
